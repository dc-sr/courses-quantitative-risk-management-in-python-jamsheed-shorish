...
`@script`
A confidence level of (say) 95% allows us to ask what the largest loss might be, 95% of the time. This is the Value at Risk statistic, or “VaR”. VaR is often expressed for 95%, 99% or 99.5% confidence levels. These levels are often represented as decimals. In our portfolio example, the 95% VaR statistic might be 60 euros for a particular loss distribution—this means that the minimum portfolio value is its starting value of 100 euros minus the 60 euro VaR, or 40 euros.
